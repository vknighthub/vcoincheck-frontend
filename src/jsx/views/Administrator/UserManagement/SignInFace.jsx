...
import { loginByFaceAction } from '../../../../store/actions/AuthActions';
...
const SignInFace = ({ users }) => {
    ...
    const faceSignIn = async () => {
        ...
        try {
            ...
            dispatch(loginByFaceAction(postData, history));
                                    ...
                                    <div className="row no-gutters">
                                        <div className="col-xl-12">
                                            <div className="form-row d-flex justify-content-between mt">
                                                <Link to="#" className="btn btn-primary" onClick={faceSignIn} >{t('scan')}</Link>
                                                <Link to="/" className="btn btn-primary ">{t('loginbyusername')}</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default withTranslation()(connect(mapStateToProps)(SignInFace));